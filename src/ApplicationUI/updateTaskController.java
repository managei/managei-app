...
public class updateTaskController {
    ...
    @FXML
    private TextField taskID_textField;
    @FXML
    ...
    void updateTask(ActionEvent event) throws SQLException {
        if(selectedTMId.equals(null)||taskID_textField.equals(null)||taskName_textField.getText().isEmpty()||taskDetails_textArea.getText().isEmpty())
        {
            label_info.setText("Please fill all fields");
            label_info.setTextFill(Color.color(1, 0, 0));
        }else{
            Main.getDashBoard().updateTask(Main.getDBHandler(),Integer.parseInt(taskID_textField.getText()),taskName_textField.getText(),taskDetails_textArea.getText(),selectedTMId);
